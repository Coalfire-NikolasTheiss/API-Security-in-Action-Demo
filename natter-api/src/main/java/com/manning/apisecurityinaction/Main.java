...
public class Main {
    ...
    public static void main(String... args) throws Exception {
        ...
        // Disable XSS protection for demo purposes.
 ...
 /* private static void badRequest(Exception ex,
      Request request, Response response) {
    response.status(400);
    // response.body(new JSONObject().put("error", ex.getMessage()).toString()); // This would be more secure because it uses a proper JSON object.
  } */
